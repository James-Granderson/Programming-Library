...
The Library records what becomes useful through actual interaction with programming. We try to avoid simply adding everything that might someday be useful all at once without proper exposure to the mechanism through implementation. 
